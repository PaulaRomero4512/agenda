...
<h2 class="text-center" style="color:#4caf9d"><strong>MODULO AGENDA</strong></h2><br>

    <a type="button" class="btn btn-sm boton" style="background-color:#7AD5C4; color: rgb(255, 255, 255);" href="add_a.php" ><strong>Nuevo Contacto</strong></a>
    ...
    <thead class="thead-dark">
        ...
        ?>
        <tr>
            <th><?php echo $agend['nombre']?></th>
            <th><?php echo $agend['citas']?></th>
            <th><?php echo $agend['telefono']?></th>
            <th>
                <a type="button" class="btn  btn-sm boton " style="background-color:#7AD5C4; color: rgb(255, 255, 255);"href="edit_a.php?id=<?php echo $agend['id_agenda']?>">Editar</a>
                <a type="button" class="btn btn-sm boton" style="background-color:#7AD5C4; color: rgb(255, 255, 255);" href="delete_a.php?id=<?php echo $agend['id_agenda']?>">Eliminar</a>
            </th>
        </tr>
          <?php
        }
