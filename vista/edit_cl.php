...
$Id =$_GET['id'];
$infoclientes = $Modelo2->getById($Id);
?>
<!DOCTYPE html>
<html>
<head>
...
<h2 class="text-center" style="color:#4caf9d"><strong>EDITAR CLIENTES</strong></h2>
...
<div class="col-sm-12 col-md-6 col-lg-4  m-auto">
    <form class="form-signin" method="POST" action="../controladores/edit_cl.php">
    ...
    <input class="form-control" type="text" name="numero" required="" autocomplete="off" placeholder="descripcion" value="<?php echo $info['numDoc_Cliente']?>">
    </div>
    <div class="form-group">
    <label for=""> <strong>Tipo Documento</strong></label>
    <input class="form-control" type="text" name="tipodoc" required="" autocomplete="off" placeholder="estado" value="<?php echo $info['tipoDoc_Cliente']?>"> 
    </div>
    <div class="form-group">
    <label for=""> <strong>Nombres</strong></label>
    <input class="form-control" type="text" name="nombres" required="" autocomplete="off" placeholder="estado" value="<?php echo $info['nombre_Cliente']?>"> 
    </div>
    <div class="form-group">
    <label for=""> <strong>Apellidos</strong></label>
    <input class="form-control" type="text" name="apellidos" required="" autocomplete="off" placeholder="estado" value="<?php echo $info['apellido_Cliente']?>"> 
    </div>
    <div class="form-group">
    <label for=""> <strong>Direccion</strong></label>
    <input class="form-control" type="text" name="direccion" required="" autocomplete="off" placeholder="estado" value="<?php echo $info['direccion_Cliente']?>"> 
    </div>
    <div class="form-group">
    <label for=""> <strong>Telefono</strong></label>
    <input class="form-control" type="text" name="telefono" required="" autocomplete="off" placeholder="estado" value="<?php echo $info['tel_Cliente']?>"> 
    </div>
    <div class="form-group">
    <label for=""> <strong>Estado</strong></label>
    <input class="form-control" type="text" name="estado" required="" autocomplete="off" placeholder="estado" value="<?php echo $info['estado_Cliente']?>"> 
    </div>
    <div class="form-group">
