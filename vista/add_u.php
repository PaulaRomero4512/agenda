...
<h2 class="text-center" style="color:#4caf9d"><strong>INGRESA USUARIO</strong></h2>
...
<div class="col-sm-12 col-md-6 col-lg-4  m-auto">
    <form class="form-signin" method="POST" action="../controladores/add_u.php">
    <div class="form-group">
    <label for=""> <strong>Correo</strong></label>
    <input class="form-control" type="email" name="login" required="" autocomplete="off" placeholder="correo">
    </div>
    <div class="form-group">
    <label for=""> <strong>Contraseña</strong></label>
    <input class="form-control" type="text" name="contrasena" required="" autocomplete="off" placeholder="Contraseña"> 
    </div>
    <div class="form-group">
    ...
    <input class="form-control" type="text" name="Rol" required="" autocomplete="off" placeholder="Rol"> 
    </div>
