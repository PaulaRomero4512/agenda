...
<h2 class="text-center" style="color:#4caf9d"><strong>MODULO SERVICIOS</strong></h2><br>

    <a type="button" class="btn btn-sm boton" style="background-color:#7AD5C4; color: rgb(255, 255, 255);" href="add_s.php" ><strong>Nuevo Servicio</strong></a>
    ...
    <a type="button" class="btn btn-sm boton" style="background-color:#7AD5C4; color: rgb(255, 255, 255);" href="index_a.php" ><strong>Agendas</strong></a>
    ...
    <thead class="thead-dark">
        ...
        $servicios = $Modelo2 -> get();
        if($servicios != null){
        foreach ($servicios as $servicio){
        ?>
        <tr>
            <th><?php echo $servicio['descripcion_Servicio']?></th>
            <th><?php echo $servicio['estado_Servicio'] ?></th>
            <th>
                <a type="button" class="btn  btn-sm boton " style="background-color:#7AD5C4; color: rgb(255, 255, 255);"href="edit_s.php?id=<?php echo $servicio['id_Servicio']?>">Editar</a>
                <a type="button" class="btn btn-sm boton" style="background-color:#7AD5C4; color: rgb(255, 255, 255);" href="delete_s.php?id=<?php echo $servicio['id_Servicio']?>">Eliminar</a>
            </th>
        </tr>
          <?php
        }
