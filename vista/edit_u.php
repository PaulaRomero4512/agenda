...
$Id =$_GET['id'];
$infousuario = $Modelo2->getById($Id);
?>
<!DOCTYPE html>
<html>
<head>
...
<h2 class="text-center" style="color:#4caf9d"><strong>EDITAR USUARIO</strong></h2>
<a type="button" class="btn btn-sm boton" style="background-color:#7AD5C4; color: rgb(255, 255, 255);" href="index_u.php"><strong>Volver</strong></a>
<div class="col-sm-12 col-md-6 col-lg-4  m-auto">
    <form class="form-signin" method="POST" action="../controladores/edit_u.php">
    ...
    <input class="form-control" type="text" name="login" required="" autocomplete="off" placeholder="Login" value="<?php echo $info['correo_Usuario']?>">
    </div>
    <div class="form-group">
    <label for=""> <strong>contraseña</strong></label>
    <input class="form-control" type="text" name="contrasena" required="" autocomplete="off" placeholder="Contraseña" value="<?php echo $info['password_Usuario']?>"> 
    </div>
    <div class="form-group">
    <label for=""> <strong>Estado</strong></label>
    <input class="form-control" type="text" name="estado" required="" autocomplete="off" placeholder="estado" value="<?php echo $info['estado_Usuario']?>"> 
    </div>
    <div class="form-group">
    <label for=""> <strong>Rol</strong></label>
    <input class="form-control" type="text" name="Rol" required="" autocomplete="off" placeholder="Rol" value="<?php echo $info['id_RolFK']?>"> 
    </div>
     <?php 
    }
     }
