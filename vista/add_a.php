...
<h2 class="text-center" style="color:#4caf9d"><strong>INGRESA AGENDA</strong></h2>
...
<div class="col-sm-12 col-md-6 col-lg-4  m-auto">
    <form class="form-signin" method="POST" action="../controladores/add_a.php">
    ...
    <input class="form-control" type="text" name="citas" required="" autocomplete="off" placeholder="citas"> 
    </div>
    <div class="form-group">
    <label for=""> <strong>Citas</strong></label>
