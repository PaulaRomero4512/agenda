...
<h2 class="text-center" style="color:#4caf9d"><strong>MODULO CITAS</strong></h2><br>

    <a type="button" class="btn btn-sm boton" style="background-color:#7AD5C4; color: rgb(255, 255, 255);" href="add_c.php" ><strong>Nueva Cita</strong></a>
    ...
    <thead class="thead-dark">
        ...
        ?>
        <tr>
            <th><?php echo $cita['fecha_Cita']?></th>
            <th><?php echo $cita['hora_Cita']?></th>
            <th><?php echo $cita['estado_Cita']?></th>
            <th><?php echo $cita['nombre_empleado']?></th>
            <th><?php echo $cita['nombre_cliente']." ".$cita['apellido_Cliente']?> </th>
            <th><?php echo $cita['descripcion_servicio']?></th>
            <th>
                <a type="button" class="btn  btn-sm boton " style="background-color:#7AD5C4; color: rgb(255, 255, 255);"href="edit_c.php?id=<?php echo $cita['id_Cita']?>">Editar</a>
                <a type="button" class="btn btn-sm boton" style="background-color:#7AD5C4; color: rgb(255, 255, 255);" href="delete_c.php?id=<?php echo $cita['id_Cita']?>">Eliminar</a>
            </th>
        </tr>
          <?php
        }
