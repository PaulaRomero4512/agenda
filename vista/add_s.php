...
<h2 class="text-center" style="color:#4caf9d"><strong>INGRESA SERVICIO</strong></h2>
...
<div class="col-sm-12 col-md-6 col-lg-4  m-auto">
    <form class="form-signin" method="POST" action="../controladores/add_s.php">
    <div class="form-group">
    <label for=""> <strong>Descripcion</strong></label>
    <input class="form-control" type="text" name="descripcion" required="" autocomplete="off" placeholder="Descripcion">
    </div>
    <div class="form-group">
