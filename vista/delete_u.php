...
<h2 class="text-center" style="color:#4caf9d"><strong>ELIMINAR USUARIO</strong></h2>
...
<div class="col-sm-12 col-md-6 col-lg-4  m-auto">
    <form method="POST" action="../controladores/delete_u.php">
    <input type="hidden" name="Id" value="<?php echo $Id; ?>">
    <h3><p class="text-black">¿estas seguro de eliminar el Usuario?</p></h3>

    <input class=" form-control btn" style="background-color:#7AD5C4; color: rgb(255, 255, 255);" type="submit" value="SI, Eliminar Usuario">
</form>
<br><br><br><br>
</div>
</Section>
