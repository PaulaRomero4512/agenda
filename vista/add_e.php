...
<h2 class="text-center" style="color:#4caf9d"><strong>NUEVO EMPLEADOS</strong></h2>
...
<div class="col-sm-12 col-md-6 col-lg-4  m-auto">
    <form class="form-signin" method="POST" action="../controladores/add_e.php">
    ...
    <input class="form-control" type="text" name="usuario" required="" autocomplete="off" placeholder="Usuarios" > 
    </div>
