...
<body>
 ...
 <section id="carrusel"> <!-- Carrusel de imágenes -->	
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 imagen" src="vista/img/2.jpg" height="600" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 imagen" src="vista/img/Tac.png" height="600" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 imagen" src="vista/img/3.png" height="600" alt="Third slide">
    </div>
  </div>
